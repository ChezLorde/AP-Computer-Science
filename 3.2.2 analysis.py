...
my_countries = ['Syrian Arab Republic', "United States", "France", "Argentina", 'Russia']

# Load in the data with read_csv()
df = pd.read_csv("3.2.2_elec_access_data.csv", header=0)    # header=0 means there is a header in row 0
